...
# usage:   stop-vms.sh <start> <end>
# example: stop-vms.sh 10 29
#          shuts down 20 existing virtual machines named vm-10 to vm-29
if [ $# -ne 2 ]; then
    echo "usage: stop-vms.sh <start> <end>"
    exit 1
fi
vmstart=$1
vmend=$2
